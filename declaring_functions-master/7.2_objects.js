...
const myCountry = {
    ...
    language: 'Hebrew',
     ...
     neighbours:[4],
     describe:function(){
         console.log(`${this.country} has ${this.population} people, their mother tongue is ${this.language}, they have ${this.neighbours} neighbouring countries and a capital called ${this.capital}`)
     },
     checkIsland:function(){
       return (!this.neighbours ? this.isIsland=true : this.isIsland =false);
     },
